...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            ...
            <p class="mb-0">Form untuk mengupdate data user.</p>
        </div>
        <div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" value="{{ $dataUser->name }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" value="{{ $dataUser->email }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                @if($dataUser->avatar)
                                    <small>
                                        Foto saat ini:
                                        <img src="{{ asset('storage/'.$dataUser->avatar) }}" width="60" class="mt-2 rounded">
                                    </small>
                                @endif
                            </div>
                        </div>
